...
<head>
    ...
    <title>Sistem Informasi FTIK Universitas Semarang</title>
    ...
    <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white py-3">
        <div class="container pb-3">
            <a href="{{ url('/') }}" class="navbar-brand">
                <span class="d-none">USM</span>
                <img src="{{ asset('/img/usm_logo.png') }}" alt="usm_logo" class="main-logo d-none d-xl-inline">
                <img src="{{ asset('/img/usm_logo.png') }}" alt="usm_logo" class="small-logo d-inline d-xl-none">
            </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 text-center text-md-start">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('img/usm_logo_black.png') }}" style="max-height: 60px;"
                            class="mb-3 img-fluid">
                    </a>
                    <p>Fakultas Teknologi Informasi dan Komunikasi mempunyai beberapa Komunitas yang bertujuan untuk mengembangkan minat dan bakat mahasiswanya, diantaranya adalah;</p>
                    <li><b>ICT</b></li>
                    <li><b>Desnet</b></li>
                    <li><b>Kober</b></li>
                    <li><b>Mobile Programming and Development Games</b></li>
                </div>
                ...
                <div class="col-md-3 text-center text-md-start">
                    <h5>Hubungi Kami</h5>
                    <div class="text-nowrap"><i class="fas fa-envelope fa-fw mr-3"></i>ftik@usm.ac.id</div>
                    <div class="text-nowrap"><i class="fas fa-phone fa-fw mr-3"></i>024 6702757</div>
                    <div class="text-nowrap"><i class="fas fa-globe fa-fw mr-3"></i>https://ftik.usm.ac.id</div>
                </div>
                <div class="row mt-3 mt-md-0">
                    <div class="col-md-3 me-md-auto text-center text-md-start">
                        <small>&copy; USM {{ date('Y') }}</small>
                    </div>
